...
def convert_voc_annotation(data_path, data_type, anno_path, use_difficult_bbox=True):
    ...
    classes = ['landslid cracks']
    img_inds_file = os.path.join(data_path, 'test_txt_1', data_type + '.txt')
...
if __name__ == '__main__':
    ...
    parser.add_argument("--data_path", default="F:/slide_dataSets/slide/imagesslide/imagestest")
    parser.add_argument("--train_annotation", default="F:/slide_dataSets/slide/imagesslide/images-train/train_txt_1/voc_train.txt")
    parser.add_argument("--test_annotation",  default="F:/slide_dataSets/slide/imagesslide/images-train/train_txt_1/voc_test.txt")
