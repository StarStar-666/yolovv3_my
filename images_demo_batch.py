...
s1 = time.time()
def batch_infer(img_dir="./docs/normal_images", output_path='D:/tensorflow-yolov3/tensorflow-serving-yolov3-master-peleenet/tensorflow-serving-yolov3-master/output'):
    # 指定第一个文件夹的位置
...
if __name__ == "__main__":
    ...
    img_dir = "F:/slide_dataSets/slide/Voc2007_1/JPEGImages/00580.jpg"
    out_put = "D:/tensorflow-yolov3/tensorflow-serving-yolov3-master-peleenet/tensorflow-serving-yolov3-master/mAP/detect"
    imgs_num = batch_infer(img_dir,out_put)
    s2 = time.time()
